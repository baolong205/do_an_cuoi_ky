const products = [
  ...
  },
  {
    ...
    description:
      "Zadez GP-803B Bluetooth over-ear headphones with superior sound quality, comfortable fit, and long battery life, ideal for music lovers and gamers.",
    rating: 4.9,
    stock: 25,
    discount: 0.2,
  },
  {
    ...
    description:
      "Compact and powerful laptop with Intel i7 processor and 16GB RAM, ideal for professionals.",
    rating: 4.8,
    stock: 30,
    discount: 0.1,
  },
  {
    ...
    description:
      "High-end MacBook with M1 Pro chip, perfect for heavy-duty tasks and creative work.",
    rating: 4.9,
    stock: 15,
    discount: 0.15,
  },
  {
    ...
    description:
      "Versatile 2-in-1 laptop with a stunning 4K display, great for work and entertainment.",
    rating: 4.7,
    stock: 20,
    discount: 0.1,
  },
  {
    ...
    description:
      "Wireless keyboard with premium build and long battery life, perfect for professionals.",
    rating: 4.8,
    stock: 30,
    discount: 0.1,
  },
